...
$excerpt = substr($content_text, 0, 150) . (strlen($content_text) > 150 ? '...' : '');
$title = "Discussion by " . htmlspecialchars(strip_tags($author)) . " - Free Degree Library Community";
$description = "Join the discussion on Free Degree Library: " . htmlspecialchars($excerpt);
$canonicalUrl = "https://degreelibrary.gt.tc/community/" . htmlspecialchars($slug);
?><!DOCTYPE html><html lang="en"><head>  <script async src="https://www.googletagmanager.com/gtag/js?id=G-VHYRJJZX5H"></script>  <script>    window.dataLayer = window.dataLayer || [];    function gtag() { dataLayer.push(arguments); }    gtag('js', new Date());    gtag('config', 'G-VHYRJJZX5H');  </script>  <meta charset="UTF-8">  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  ...
  <title>Community Post - Free Degree Library</title>
  <meta name="description" content="Read and discuss community posts, questions, and insights shared by students on Free Degree Library.">
  <meta name="keywords" content="community discussion, student posts, Q&A">
  <meta name="author" content="Cirravo Solutions">
  <link rel="canonical" href="https://degreelibrary.gt.tc/community_post.php">
  
  <!-- Open Graph / Facebook -->
  <meta property="og:type" content="website">
  <meta property="og:url" content="https://degreelibrary.gt.tc/community_post.php">
  <meta property="og:title" content="Community Post - Free Degree Library">
  <meta property="og:description" content="Read and discuss community posts, questions, and insights shared by students on Free Degree Library.">
  <meta property="og:image" content="/logo.png">
  
  <!-- Twitter -->
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:url" content="https://degreelibrary.gt.tc/community_post.php">
  <meta name="twitter:title" content="Community Post - Free Degree Library">
  <meta name="twitter:description" content="Read and discuss community posts, questions, and insights shared by students on Free Degree Library.">
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "WebSite",
    "name": "Community Post - Free Degree Library",
    "description": "Read and discuss community posts, questions, and insights shared by students on Free Degree Library.",
    "url": "https://degreelibrary.gt.tc/community_post.php"
  }
  </script>
