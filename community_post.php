...
(function() {
  ...
  <link rel="stylesheet" href="/style.min.css?v=6.9.1"><style>
  ...
  <line x1="77%" y1="80%" x2="88%" y2="80%" class="line" />
      ...
      <div style="display: flex; align-items: center; gap: 15px; flex-shrink: 0; color: white;">
        <!-- App Web Link --><a href="https://1amgiri.itch.io/free-degree-library" target="_blank" class="nav-icon-link app-web-btn" title="Open in Browser" style="color: white; padding: 0; margin: 0; display: none;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 2a14.5 14.5 0 0 0 0 20 14.5 14.5 0 0 0 0-20"/><path d="M2 12h20"/></svg></a><!-- Mobile Subscribe Bell -->
...
?>
  ...
  <script src="/app.min.js?v=5.3.0"></script>  <!-- Sidebar overlay backdrop -->
